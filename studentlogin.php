			...
			<form action="loginauthen.php" method="post">
				<fieldset style="width:450px;height:auto;margin:auto;margin-top:85px;border-radius:4px;">
					...
					<table style="margin:0 auto;">
							<tr>
								<td colspan="2"><b>Enrollment:</td>
									<td colspan="2"><input type="text" class="textarea" id="uname" name="uname" placeholder="Enrollment" style="width:100%;" pattern="[0-9]{11}+" required ></td>
							</tr>
							<tr><td><br/></td></tr>
							<tr>
								<td colspan="2"><b>Password:</td>
									<td colspan="2"><input type="password" class="textarea" id="pass" name="pass" placeholder="Password" style="width:100%;" required> </td>
